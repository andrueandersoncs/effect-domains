import { Cause, Effect, Exit, Layer, Match, Option, Schema, pipe } from "effect"
...
import { ApplicationCluster } from "effect-domains/application-cluster"
...
const ClusterStatus = Rpc.make("DurableWorkflow.Status", {
  success: ApplicationCluster.Status,
...
const operatorHandlers = operatorGroup.toLayer({
  ...
  "DurableWorkflow.Status": Effect.fn("DurableWorkflows.Status")(function* () {
    return yield* ApplicationCluster.status()
  }),
})
