import { Context, Effect, Schema, SchemaGetter, Struct, pipe } from "effect"
...
export const StoredNoteSchema = NoteSchema.mapFields(Struct.assign({ text: StoredTextSchema }))
