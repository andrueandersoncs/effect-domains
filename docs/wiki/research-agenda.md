...
The dated [authorization verification](validation-strategy.md#2026-09-08-resource-authorization) records the current policy, identity-isolation, SQL parity, and live CLI evidence. [CRUD and codec verification](validation-strategy.md#2026-09-08-crud-and-json-codec-simplification) and older records remain historical evidence for their exercised interfaces.
