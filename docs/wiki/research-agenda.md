...
The dated [CRUD and codec verification](validation-strategy.md#2026-09-08-crud-and-json-codec-simplification) records the current exercised cases and test/type evidence. Older records remain historical rather than proof of the current API.
