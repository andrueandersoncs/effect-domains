...
- [Tables and Queries](tables-and-queries.md) — resource authorization, bounded lists, explicit migration artifacts, runtime, and native execution composition.
- [Validation Strategy](validation-strategy.md) — slice criteria, current cutover validation, dated evidence, and limits.
