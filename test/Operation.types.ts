...
Operation.make({ name: "types.declared", success: Schema.Void, error: ErrorSchema, unavailable: OperationUnavailable, handler: declared })
Operation.make({ name: "types.infrastructure", success: Schema.Void, error: ErrorSchema, unavailable: OperationUnavailable, handler: infrastructure })
Operation.make({ name: "types.untagged", success: Schema.Void, error: ErrorSchema, unavailable: OperationUnavailable, handler: untagged })
